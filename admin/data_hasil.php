  ...
  for ($i=0; $i < $n_iterasi; $i++) {
    ...
    if ($i == 0) {
      ...
      for ($j=0; $j < $n_cluster; $j++) {
        $query_centroid = "SELECT data_nilai.*, data_hasil.*, AVG(data_nilai.c1) as 'c1', AVG(data_nilai.c2) as 'c2', AVG(data_nilai.c3) as 'c3', AVG(data_nilai.c4) as 'c4', AVG(data_nilai.c5) as 'c5',  AVG(data_nilai.c6) as 'c6',  AVG(data_nilai.c7) as 'c7' FROM data_hasil, data_nilai WHERE data_hasil.id_nilai = data_nilai.id_nilai AND data_hasil.Cluster = 'Cluster-".($j+1)."'";
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Data Hasil Penentuan Kluster</h3>
        ...
        <div class="box-body">
          <a href="proses_perhitungan.php" target="_blank()" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
            <i class="fas fa-sm text-white-50"></i>Proses Perhitungan
          </a>
          <hr>
          <div class="table-responsive">
            <table class="table table-bordered" id="example1" width="100%" cellspacing="0">
              ...
              <tbody>
                <?php
                  $no = 1;
                  $query = mysqli_query($koneksi, "SELECT data_nilai.*, data_siswa.*, data_hasil.* FROM data_hasil, data_nilai, data_siswa WHERE data_nilai.nis = data_siswa.nis AND data_hasil.id_nilai = data_nilai.id_nilai");
