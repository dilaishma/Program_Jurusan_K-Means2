...
$id     = $_SESSION['id'];
$ambil  = mysqli_query($koneksi, "SELECT * FROM data_siswa WHERE nis = '$_SESSION[id]'");
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg">KMEANS <b>CLUSTERING</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu">
            <a href="data_admin.php" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?= $dt['nama_siswa'] ?></span>
            </a>
            <ul class="dropdown-menu">
              <li class="user-header">
                <img src="../logo1.png" class="img-circle" alt="User Image">
                <p>
                  <?= $dt['nama_siswa'] ?> - Informatika
                  <small>NIM : </small>
                </p>
              </li>
              <li class="user-footer">
                <div class="pull-left">
                  <a href="data_siswa.php" class="btn btn-default btn-flat">Profile</a>
                </div>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="ganti_password.php"><i class="fa fa-circle-o"></i>GANTI PASSWORD</a></li>
          </ul>
        </li>
      </ul>
    </section>
